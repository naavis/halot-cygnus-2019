(function() {
  window.canvases.parryCrystals = {
    initialize: function(canvas) {
      ...
      columnCrystal.scale.x = columnCrystal.scale.y = columnCrystal.scale.z = 3.5;
      ...
      function animate() {
        ...
        xRotMatrix.makeRotationX(Math.PI / 2.0 + 0.02 * Math.sin(4 * t));
